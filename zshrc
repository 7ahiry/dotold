...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/lib/jvm/default/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:/home/tahiry/bin:${HOME}/.local/bin/:"
...
export LESS="-R"
export PATH="${PATH}:/usr/local/bin:/usr/bin:/usr/local/lib:/home/tahiry/bin:/usr/local/texlive/2013/bin/x86_64-linux:/usr/local/wsnet-2.0/bin:/usr/libexec/git-core:/home/tahiry/too/ns/ns-allinone-2.35/bin:/home/tahiry/too/ns/ns-allinone-2.35/tcl8.5.10/unix:/home/tahiry/too/ns/ns-allinone-2.35/tk8.5.10/unix"
